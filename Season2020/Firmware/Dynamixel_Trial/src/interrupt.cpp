...
void attachInterrupt(){
	...
	//Arm_L.attach(ArmData_receive_L, UnbufferedSerial::RxIrq);
	//Arm_L.attach(ArmData_Switch_L, UnbufferedSerial::TxIrq);
    Timer_interrupt.attach(&timer, 1ms);
	//Dynamixel_interrupt.attach_us(&ArmData_Switch_L, 40);
}