...
//extern const short ArmPosition_L[6][5][4];
//extern const short ArmPosition_R[6][5][4];
...
//extern short select_command[20];      //予選
extern short select_command[24];        //決勝
//extern short select_command_finals[20];
extern bool finishFlag;
extern bool ActiveFlag;
extern bool Check_L, Check_R, Check_Time;
extern bool Check_Move;
